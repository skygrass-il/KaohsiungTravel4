...
function updatePoint() {
    ...
    for (let i = start - showPnum; i < dataLen; i++) {
        if (nowData[i].Ticketinfo === '免費參觀' || nowData[i].Ticketinfo ==='新台幣50元') {
            strT = nowData[i].Ticketinfo;
            flag = `<li><img src="img/icons_tag.png"><p>${strT}</p></li>`;
        }else if(nowData[i].Ticketinfo === 'DIY手做教學 200元/人提供用餐服務 150/人') {
            strT = '需付費';
            flag = `<li><img src="img/icons_tag.png"><p>${strT}</p></li>`;
        }else{
            flag = '';
        ...
        str += `<div class="point">
                  ...
                  <ul class="newList">
                     <li><img src="img/icons_clock.png"><p>${nowData[i].Opentime}</p></li>
                     <li><img src="img/icons_pin.png"><p>${nowData[i].Add}</p></li>
                     <li><img src="img/icons_phone.png"><p>${nowData[i].Tel}</p></li>
                     ${flag}
                   </ul>
                </div>`
    }
